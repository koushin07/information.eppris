<template>
    ...
    <div class="flex flex-col mx-10 mt-4 gap-10">
        <div class="flex flex-col justify-end h-fit">
            <span class="text-xl font-bold"> TOTAL EQUIPMENT </span>
            <span
                class="text-5xl"
        ...
        <div class="flex flex-col w-full">
            <div
                class="flex flex-col-reverse md:flex-row gap-7 justify-end w-full"
            >
                <div class="flex flex-row justify-between w-full">
                    ...
                    >
                        <span
                            class="text-slate-600 text-lg font-bold tracking-wider"
                            >SERVICEABLE</span
                        >
                        <span
            ...
            <div class="flex flex-row space-x-6 h-[250px] md:h-[300px]">
                <div
                    class="grid place-content-center content-box px-4 rounded-xl bg-white shadow-5 mt-4"
                >
                ...
                >
                    <span class="font-bold text-lg mb-6 text-red-500"
                        >On Critical Condition Equipment</span
                    >
                    <ul
                    ...
                    >
                        <li
                            class="pb-3 sm:pb-4"
                            v-for="(critacal, key) in criticals"
                        >
                            <div
                            ...
                            >
                                <div class="flex-1 min-w-0">
                                    <p
                                        class="text-sm font-medium text-gray-500 truncate dark:text-white"
                                    >
                                        Equipment
                                    </p>
                                    <p
                                        class="text-sm text-gray-900 truncate font-semibold dark:text-gray-400"
                                    >
                                        {{ key }}
                                    </p>
                                </div>
                                <div class="flex flex-col min-w-0 justify-end">
                                    ...
                                    <p
                                        class="text-sm text-gray-900 truncate font-semibold dark:text-gray-400 text-end"
                                    >
                                        {{ critacal }}
                                    </p>
                                </div>
        ...
        <div class="flex flex-col space-y-5">
            <div class="flex flex-row justify-between">
                <div class="flex flex-row space-x-3">
                    <a
                        href="/api/invoice-data"
                        class="border-2 rounded px-3 w-fit py-1 text-orange-400 font-semibold tracking-wider border-orange-500"
                        >Export Report
                    </a>
                </div>
            </div>
            ...
            <div class="relative">
                <Table>
                    ...
                    <template #body>
                        <tr
                            class="max-h-full even:bg-orange-200 bg-white border-b dark:bg-gray-800 dark:border-gray-700"
...
export default {
    ...
    setup({ filters, status, equipments }) {
        ...
        const percentage = computed(() => {
            const serviceable = Math.floor(
                (status.serviceable / status.total) * 100
            );
            const unserviceable = Math.floor(
                (status.unserviceable / status.total) * 100
            );
                    ...
                    datasets: [
                        {
                            label: "Status",
                            data: [
                                percentage.value.serviceable,
                                percentage.value.poor,
                                percentage.value.unserviceable,
                            ],
                            borderWidth: 1,
                            backgroundColor: ["#FFA34E", "#BA882F", "#7E6B19"],
                            borderColor: ["#FFA34E", "#BA882F", "#7E6B19"],
                        },
                    ],
                },
                options: {
