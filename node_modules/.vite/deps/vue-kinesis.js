...
function throttle(callback, delay, type) {
  ...
  return function() {
    ...
    if (type === "scroll") {
      ...
      newDelay = context.duration > 1e3 ? delay : context.duration / 10;
    }
    const now = +new Date();
  ...
  methods: {
    ...
    getSongData() {
      if (this.isPlaying) {
        ...
        this.audioData = new Array(this.audioArray);
...
var script$3 = {
  ...
  methods: {
    transformMovement() {
      ...
      if (!context.isMoving && context.event === "move")
        return {};
      let movementX;
      let movementY;
      ...
      if (this.cycle <= 0) {
        ...
        if (isScroll) {
          const scrollMovement2 = elementMovement({
          ...
          movementX = this.axis === "x" ? scrollMovement2 : 0;
          movementY = this.axis === "y" || !this.axis ? scrollMovement2 : 0;
        }
...
var script$4 = {
  ...
  methods: {
    ...
    transformBehavior(shape) {
      ...
      if (this.cycle <= 0) {
        const scrollMovement2 = scrollPosition * this.strength;
        movementX = this.axis === "x" ? scrollMovement2 : 0;
        movementY = this.axis === "y" || !this.axis ? scrollMovement2 : 0;
        if (this.maxX) {
...
var install = function installVueKinesis(app) {
...
var vue_kinesis_esm_default = install;

// dep:vue-kinesis
var vue_kinesis_default = vue_kinesis_esm_default;
export {
  script as KinesisAudio,
  script$1 as KinesisContainer,
  script$2 as KinesisDistance,
  script$3 as KinesisElement,
  script$4 as KinesisScroll,
  vue_kinesis_default as default
};
//# sourceMappingURL=vue-kinesis.js.map
